			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="accordion faq">
						...
						<div class="content">
							<p>
							   일반 개인 투자자의 경우 "불특정 다수로 부터 자금을 모집하는 행위에 대한 유사수신행위"의 법률적 검토 및 관계 당국과의 협의를 거친 후 open 될 예정이며, open 시에 투자 방식에 대하여도 자세히 설명될 예정입니다.
							</p>
						</div><!-- .content end -->
						...
						<div class="content">
							<p>
								투자는 대출에 대한 포트폴리오 투자로서 각 대출이자율은 다를 수 있으나, 제시 될 투자수익률은 투자대상 대출채권의 포트폴리오가 확정되면 일정하게 제시될 예정입니다. (현재 8~10% 예정). 
							</p>
						</div><!-- .content end -->
						...
						<div class="content">
							<p>
								30cut은 투자자의 보호를 위하여 대출 포트폴리오에 대한 변제 순위가 제일 늦은 "후순위 투자"를 부담으로 미연에 투자자 손실 보호를 도모할 예정입니다.
							</p>
						</div><!-- .content end -->
